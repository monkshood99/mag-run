...
// Returns an instance of _us for OO-style calls
function _us($item=null) {
  $_us = new _us;
  if(func_num_args() > 0) $_us->_wrapped = $item;
  return $_us;
}
...
class _us {
  ...
  public function chain($item=null) {
    ...
    $_us = (isset($this) && isset($this->_chained) && $this->_chained) ? $this : _us($item);
    $_us->_chained = true;
    return $_us;
  }
  ...
  public function reduceRight($collection=null, $iterator=null, $memo=null) {
    ...
    $_us = new self;
    return self::_wrap($_us->reduce($collection, $iterator, $memo));
  }
  ...
  public function invoke($collection=null, $function_name=null, $arguments=null) {
    ...
    $_us = new self;
    list($collection, $function_name) = $_us->first($args, 2);
    $arguments = $_us->rest(func_get_args(), 2);
  ...
  public function any($collection=null, $iterator=null) {
    ...
    $_us = new self;
    if(!is_null($iterator)) $collection = $_us->map($collection, $iterator);
  ...
  public function initial($collection=null, $n=null) {
    ...
    $_us = new self;
    return self::_wrap($_us->first($collection, $first_index));
  }
  ...
  public function compact($collection=null) {
    ...
    $_us = new self;
    return self::_wrap($_us->select($collection, function($val) {
      return (bool) $val;
    }));
  }
  ...
  public function flatten($collection=null, $shallow=null) {
    ...
    if(count($collection) > 0) {
      foreach($collection as $item) {
        if(is_array($item)) {
          $_us = new self;
          $return = array_merge($return, ($shallow) ? $item : $_us->flatten($item));
        }
        else $return[] = $item;
      }
    }
  ...
  public function intersection($array=null) {
    ...
    $_us = new self;
    $return = $_us->first($arrays);
    foreach($_us->rest($arrays) as $next) {
      if(!$_us->isArray($next)) $next = str_split((string) $next);
  ...
  public function union($array=null) {
    ...
    $_us = new self;
    return self::_wrap($_us->flatten(array_values(array_unique(call_user_func_array('array_merge', $arrays)))));
  }
  ...
  public function lastIndexOf($collection=null, $item=null) {
    ...
    krsort($collection);
    $_us = new self;
    return self::_wrap($_us->indexOf($collection, $item));
  }
  ...
  public function range($stop=null) {
    ...
    $_us = new self;
    $args = $_us->reject($args, function($val) {
      return is_null($val);
    });
    ...
    if($step > 0 && $_us->last($results) >= $stop) array_pop($results);
    elseif($step < 0 && $_us->last($results) <= $stop) array_pop($results);
  ...
  public function zip($array=null) {
    ...
    $_us = new self;
    $num_return_arrays = $_us->max($_us->map($arrays, function($array) {
      return count($array);
    }));
    $return_arrays = $_us->range($num_return_arrays);
  ...
  public function max($collection=null, $iterator=null) {
    ...
    arsort($results);
    $_us = new self;
    $first_key = $_us->first(array_keys($results));
  ...
  public function extend($object=null) {
    ...
    $array = (array) $object;
    $_us = new self;
    $extensions = $_us->rest(func_get_args());
  ...
  public function isEqual($a=null, $b=null) {
    ...
    if(is_object($a) || is_array($a)) {
      ...
      $_us = new self;
      $keys_equal = $_us->isEqual($_us->keys($a), $_us->keys($b));
      $values_equal = $_us->isEqual($_us->values($a), $_us->values($b));
