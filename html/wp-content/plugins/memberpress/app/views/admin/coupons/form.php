        ...
        <th scope="row">
          ...
          <?php
            MeprAppHelper::info_tooltip(
              ...
              __("<b>Standard:</b> This simply applies the discount to the amount of the charge or subscription.<br/><br/><b>First Payment Only:</b> This will apply the discount to only the first payment. This option only works on recurring payments and creates a custom trial used as the first payment so it will prevent any trials associated with the membership from working. The discount set above will NOT apply to the subscription’s recurring amount.<br/><br/><b>Trial Override:</b> This will create a custom trial period based on the number of days & trial cost here. This option only works on recurring payments and will prevent any trials associated with the membership from working. The discount set above will still apply to the subscription’s recurring amount.", 'memberpress') );
          ?>
        </th>
        <td>
          <select name="<?php echo MeprCoupon::$discount_mode_str; ?>" class="mepr-toggle-select" data-trial-override-box="mepr_trial_override_box">
            <option value="standard" <?php selected($c->discount_mode, 'standard'); ?>><?php _e('Standard', 'memberpress'); ?></option>
            <option value="first-payment" <?php selected($c->discount_mode, 'first-payment'); ?>><?php _e('First Payment Only', 'memberpress'); ?></option>
